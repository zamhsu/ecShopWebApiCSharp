...
namespace WebApi.Infrastructures.Helpers
{
    public class JwtHelper
    {
        ...
        /// <returns></returns>
        public string GenerateToken(string userName, string guid, MemberRoleEnum memberRole, DateTime expireDateTime)
        {
            ...
            // 自行擴充claims
            claims.Add(new Claim(CustomClaimType.Guid, guid));
